...
def p_teoremi():
    ...
    etiket2.config(text="Tamam! Hemen bir Pisagor teoremi hesaplama işlemi yapabiliriz! Lütfen sayıları girin.")
    etiket3 = Label(pencere2, text="Birinci dik kenar:")
    etiket3.pack()
    entry = ttk.Entry(pencere2)
    entry.pack()
    etiket4 = Label(pencere2, text="İkinci dik kenar:")
    etiket4.pack()
    entry2 = ttk.Entry(pencere2)
    entry2.pack()
    def gönder():
...
def bilimsel():
    ...
    dgm6.place(relx=0.895, rely=0.129)
    dgm7.place(relx=0.944, rely=0.129)
    dgm8.place(relx=0.895, rely=0.161)
    dgm9.place(relx=0.944, rely=0.161)
    dgm10.place(relx=0.895, rely=0.193)
    dgm11.place(relx=0.944, rely=0.193)
    dgm12.place(relx=0.895, rely=0.225)
    dgm13.place(relx=0.944, rely=0.225)
    dgm14.place(relx=0.895, rely=0.257)
    dgm15.place(relx=0.944, rely=0.257)
    dgm16.place(relx=0.895, rely=0.289)
    dgm17.place(relx=0.944, rely=0.289)
    dgm22.place(relx=0.895, rely=0.321)
    dgm23.place(relx=0.944, rely=0.321)
    dgm24.place(relx=0.895, rely=0.353)
    dgm25.place(relx=0.944, rely=0.353)
def göster():
